...
class DataSetHelper:
    ...
    def readCSVFile(self, file, target, noramlize=False):
        ...
        and returns it in a form of enumerate object. This 
        enumerate object can 
        then be used directly in for loops or be converted 
        ...
        """
         ...
         a vectorized function which takes a nested sequence of 
         objects or numpy arrays as inputs and returns a single numpy
          array or a tuple of numpy arrays. 
        """
