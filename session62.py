...
print("TRANFORMED TARGET")
print(YScale)

# # Preparing Training and Testing Data
X_train, X_test, Y_train, Y_test = train_test_split(XScale, YScale)

# STE22: CREATINF ANN MODEL FOR REGRESSION
#  Input Layer -> Hidden Layer -> Output Layer
#     5              4                1

# PS: If we choose any extra neurons, during the
# training process, with every epoch it gets optimized and unwanted neurons or layers are removed
